...
using MyPortal.Identity;
using MyPortal.MultiTenancy;
using MyPortal.Sessions;
using MyPortal.Web.Models.Account;
using MyPortal.Web.Views.Shared.Components.TenantChange;

namespace MyPortal.Web.Controllers
{
    public class AccountController : MyPortalControllerBase
    {
